...
def run_model(cat_num, cha_num, lean_rate, kp, tr_fl, bat_num, iter_num, va_once, GPU_str, va_ind, sa_str=None):
    # saving folder
    if tr_fl == 'yes':
        sa_str = spb.com_mul_str([cat_num, cha_num, va_ind, bat_num, GPU_str])
